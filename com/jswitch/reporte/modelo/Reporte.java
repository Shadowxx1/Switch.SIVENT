...
public class Reporte extends BeanVO implements Serializable {
    ...
    @Column
    @BusinessKey(exclude = Method.EQUALS)
    private String vistaFiltro;
    /**
     * Controlador que se encargara de levartar la vista del Filtro
     */
    @Column
    @BusinessKey(exclude = Method.EQUALS)
    private String controllerFiltro;
    /**
     * TIPO
     * 0 DETALLE
     * 1 RESUMEN
    ...
    public Reporte(CategoriaReporte categoria, FiltroReporte filtro, String controllerFiltro, String vistaFiltro, int tipo, String file, String titulo, String observacion, String baseSQL, String tipoPapel, Boolean filtroObligado, Boolean hql, Boolean enviarData, Boolean useFieldDescription) {
        this.filtro = filtro;
        this.categoria = categoria;
        this.tipo = tipo;
        this.file = file;
    ...
    /**
     * Vista de Filtro
     * @return the vistaFiltro
     */
    public String getVistaFiltro() {
        return vistaFiltro;
    }

    /**
     * Vista de Filtro
     * @param vistaFiltro the vistaFiltro to set
     */
    public void setVistaFiltro(String vistaFiltro) {
        this.vistaFiltro = vistaFiltro;
    }

    /**
     * Controlador que se encargara de levartar la vista del Filtro
     * @return the controllerFiltro
     */
    public String getControllerFiltro() {
        return controllerFiltro;
    }

    /**
     * Controlador que se encargara de levartar la vista del Filtro
     * @param controllerFiltro the controllerFiltro to set
     */
    public void setControllerFiltro(String controllerFiltro) {
        this.controllerFiltro = controllerFiltro;
    }
}
