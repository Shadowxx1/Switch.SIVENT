...
import com.jswitch.base.controlador.MenuPrincipal;
 ...
 */
public class SMSPreEscritosGridFrame extends DefaultGridFrame {

    public SMSPreEscritosGridFrame() {
    }
    ...
    private void initComponents() {
        ...
        gridData.setValueObjectClassName(SMSPreEscrito.class.getName());
        ...
        textColumn6.setMaxCharacters(160);
        textColumn6.setPreferredWidth(350);
    ...
    private void insertButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_insertButton1ActionPerformed
        ((MenuPrincipal) MDIFrame.getClientFacade()).getSMSPreEscrito();
