 ...
 */
public class AlmacenesGridFrame extends DefaultGridFrame {

    public AlmacenesGridFrame() {
    }
    ...
    private void initComponents() {
        ...
        gridData.setValueObjectClassName(Almacen.class.getName());
        ...
        textColumn1.setPreferredWidth(140);
        ...
        textColumn2.setPreferredWidth(150);
        gridData.getColumnContainer().add(textColumn2);

        textColumn3.setColumnFilterable(true);
        textColumn3.setColumnName("ubicacion");
        ...
        checkBoxColumn1.setColumnName("principal");
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(gridData, javax.swing.GroupLayout.DEFAULT_SIZE, 625, Short.MAX_VALUE)
                .addContainerGap())
        );
        jPanel2Layout.setVerticalGroup(
            jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                .addComponent(gridData, javax.swing.GroupLayout.DEFAULT_SIZE, 266, Short.MAX_VALUE)
                .addContainerGap())
        );
