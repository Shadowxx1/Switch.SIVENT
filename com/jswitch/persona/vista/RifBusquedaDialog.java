...
public class RifBusquedaDialog extends javax.swing.JDialog {
            ...
            .addGroup(form1Layout.createSequentialGroup()
                ...
                .addGroup(form1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(form1Layout.createSequentialGroup()
                        ...
                        .addGroup(form1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(tipoCedula, javax.swing.GroupLayout.DEFAULT_SIZE, 212, Short.MAX_VALUE)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, form1Layout.createSequentialGroup()
                                .addComponent(numericControl2, javax.swing.GroupLayout.DEFAULT_SIZE, 186, Short.MAX_VALUE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                ...
                try {
                    ...
                    if (attName != null && entityName != null) {
                        for (int i = 0; i < attName.length && beanVO == null; i++) {
                            Response res = buscar(s, entityName[i], attName[i]);
    ...
    private Response buscar(Session s, String entityName, String attName) {
        Query q = null;
        List lista = null;
        if (numericControl1.getText() != null && !numericControl1.getText().trim().isEmpty()) {
            q = s.createQuery("FROM " + entityName
                    + " WHERE " + attName + ".rif.rif=?").
                    setString(0, textControl2.getText());
            lista = q.list();
            if (!lista.isEmpty()) {
                beanVO = (BeanVO) lista.get(0);
            ...
            if (!lista.isEmpty()) {
                if (lista.size() == 1) {
                    ...
                    beanVO = null;
                    return new ErrorResponse("Multiples Resultados");
                    //TODO PARA MAS PERSONAS
                }
            }
        }
