...
public class Dominios {
    ...
    public static Hashtable getDominios() {
        ...
        domains.put(
                Dominios.TipoProducto().getDomainId(),
                Dominios.TipoProducto());
        domains.put(
                Dominios.ClaseProducto().getDomainId(),
                Dominios.ClaseProducto());
        domains.put(
                Dominios.TipoCodigoBarras().getDomainId(),
                Dominios.TipoCodigoBarras());
        domains.put(
                Dominios.TipoPrecio().getDomainId(),
                Dominios.TipoPrecio());
        domains.put(
                Dominios.TipoDemanda().getDomainId(),
                Dominios.TipoDemanda());
        domains.put(
                Dominios.TipoCalculoPrecio().getDomainId(),
                Dominios.TipoCalculoPrecio());
        domains.put(
                Dominios.TipoImpuesto().getDomainId(),
                Dominios.TipoImpuesto());
    ...
    public static enum EstatusSMS {
        ...
        PENDIENTE, ENVIADO, SIN_CONEXION, NO_ENVIADO, NO_ENVIADO2, MUY_LARGO,
        SIN_NUMERO, CREDITOS_INSUFICIENTES, ATENTICACION_INVALIDA, CUENTA_INVALIDA,
        TIPOCUENTA_INVALIDA, PETICION_SOBRECARGADA,RECIBIDO
    }
    ...
    public static enum TipoProducto { //listo

        PRODUCTO, PAQUETE, SERVICIO, SOFTWARE;
    }

    public static Domain TipoProducto() {
        Domain dominio = new Domain("TipoProducto");
        TipoProducto o[] = TipoProducto.values();
        for (int i = 0; i
                < o.length; i++) {
            dominio.addDomainPair(o[i], o[i].toString());
        }
    ...
    public static enum ClaseProducto { //listo

        A, B, C, D, E;
    }

    public static Domain ClaseProducto() {
        Domain dominio = new Domain("ClaseProducto");
        ClaseProducto o[] = ClaseProducto.values();
        for (int i = 0; i
                < o.length; i++) {
            dominio.addDomainPair(o[i], o[i].toString());
        }
    ...
    public static enum TipoCodigoBarras { //listo

        EAN, EAN_14, CODE128, ISBN, UPC_A, UPC_B;
    }

    public static Domain TipoCodigoBarras() {
        Domain dominio = new Domain("TipoCodigoBarras");
        TipoCodigoBarras o[] = TipoCodigoBarras.values();
        for (int i = 0; i
                < o.length; i++) {
            dominio.addDomainPair(o[i], o[i].toString());
        }
    ...
    public static enum TipoDemanda { //listo

        ALTA, BAJA, REGULAR;
    }

    public static Domain TipoDemanda() {
        Domain dominio = new Domain("TipoDemanda");
        TipoDemanda o[] = TipoDemanda.values();
        for (int i = 0; i
                < o.length; i++) {
            dominio.addDomainPair(o[i], o[i].toString());
        }
    ...
    public static enum TipoCalculoPrecio { //listo

        PRECIO_COMPRA, DESCUENTO;
    }

    public static Domain TipoCalculoPrecio() {
        Domain dominio = new Domain("TipoCalculoPrecio");
        TipoCalculoPrecio o[] = TipoCalculoPrecio.values();
        for (int i = 0; i
                < o.length; i++) {
            dominio.addDomainPair(o[i], o[i].toString());
        }
    ...
    public static enum TipoPrecioVenta { //listo

        DETAL, MAYOR;
    }

    public static Domain TipoPrecioVenta() {
        Domain dominio = new Domain("TipTipoPrecioVentaoPrecio");
        TipoPrecioVenta o[] = TipoPrecioVenta.values();
        for (int i = 0; i
                < o.length; i++) {
            dominio.addDomainPair(o[i], o[i].toString());
        }
    ...
    public static enum TipoImpuesto { //listo

        GENRAL, PERSONALIZADO;
    }

    public static Domain TipoImpuesto() {
        Domain dominio = new Domain("TipoImpuesto");
        TipoImpuesto o[] = TipoImpuesto.values();
        for (int i = 0; i
                < o.length; i++) {
            dominio.addDomainPair(o[i], o[i].toString());
        }
    ...
    public static enum UnidadTiempo { //listo

        DIAS, SEMANAS, MESES, AYOS;
    }

    public static Domain UnidadTiempo() {
        Domain dominio = new Domain("UnidadTiempo");
        UnidadTiempo o[] = UnidadTiempo.values();
        for (int i = 0; i
                < o.length; i++) {
            dominio.addDomainPair(o[i], o[i].toString());
        }
    ...
    public static enum TipoOperacionCalculoPrecio { //listo

        CATEGORIA, PREC_MED_COMPRA, PREC_MED_COSTE, PREC_COMPRA_LOTE, PREC_COST_LOTE;
    }

    public static Domain TipoOperacionCalculoPrecio() {
        Domain dominio = new Domain("TipoOperacionCalculoPrecio");
        TipoOperacionCalculoPrecio o[] = TipoOperacionCalculoPrecio.values();
        for (int i = 0; i
                < o.length; i++) {
            dominio.addDomainPair(o[i], o[i].toString());
        }
    ...
    public static enum TipoRedondeo { //listo

        ABAJO, ARRIBA;
    }

    public static Domain TipoRedondeo() {
        Domain dominio = new Domain("TipoRedondeo");
        TipoRedondeo o[] = TipoRedondeo.values();
        for (int i = 0; i
                < o.length; i++) {
            dominio.addDomainPair(o[i], o[i].toString());
        }
    ...
    public static enum TipoPrecio { //listo

        GENERAL, PERSONALIZADO;
    }

    public static Domain TipoPrecio() {
        Domain dominio = new Domain("TipoPrecio");
        TipoPrecio o[] = TipoPrecio.values();
        for (int i = 0; i
                < o.length; i++) {
            dominio.addDomainPair(o[i], o[i].toString());
        }
    ...
    public static enum FiltroReporte {

        FACTURA, PERSONA, REEMBOLSO, DETALLESINIESTRO
    ,   ORDENPAGO, REMESA, SINIESTRO}
}
