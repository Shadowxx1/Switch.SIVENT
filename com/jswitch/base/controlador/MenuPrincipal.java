...
import com.jswitch.inventario.controlador.ProductoDetailFrameController;
import com.jswitch.inventario.modelo.Almacen;
import com.jswitch.inventario.modelo.Unidad;
import com.jswitch.inventario.vista.AlmacenesGridFrame;
import com.jswitch.inventario.vista.ProductoDetailFrame;
import com.jswitch.inventario.vista.UnidadGridFrame;
...
import com.jswitch.sms.vista.SMSPreEscritoDetailFrame;
...
// </editor-fold>
    ...
    public void getNuevoProducto() {
        new ProductoDetailFrameController(ProductoDetailFrame.class.getName(), null, null, Boolean.FALSE);
    }

    public void getUnidades() {
        new DefaultGridFrameController(UnidadGridFrame.class.getName(), null, Unidad.class.getName(), "Unidades");
    }

    public void getAlmacenes() {
        new DefaultGridFrameController(AlmacenesGridFrame.class.getName(), null, Almacen.class.getName(), "Almacenes");
    }
