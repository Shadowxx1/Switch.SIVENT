...
import com.jswitch.base.controlador.helpcenter.CorreoSMTP;
...
public class Principal implements MDIController, LoginController {
    ...
    static {
        General.version = "Version: 1.1 - 2013";
        General.edition = "Cachapas Y Luncheria Don Noel";
        General.splashLine2 = "Ventas e Inventario";
        General.contacto="nelsonj.moncada@gmail.com 0426-1773440";
        General.copyRight="© Copyright 2013 Desarrolladores del Cambio C.A. - Todos los Derechos Reservados";
    }
...
//        ClientSettings.LOOK_AND_FEEL_CLASS_NAME = javax.swing.UIManager.getCrossPlatformLookAndFeelClassName();
        ...
        ClientSettings.ICON_FILENAME = "financiamiento.png";
...
//        }
    ...
    public final void validarLicencia() {
        ...
        if (!valido) {
            ...
            CorreoSMTP.enviarCorreo("jsipolee@jsipol.com", "jsipolee@gmail.com",
