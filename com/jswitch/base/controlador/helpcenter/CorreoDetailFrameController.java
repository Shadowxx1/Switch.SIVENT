...
import com.jswitch.base.vista.sistema.soporteTecnico.CorreoDetailFrame;
...
public class CorreoDetailFrameController extends FormController implements ActionListener {
    ...
    private String server = General.configuracion.getRutaDocDigitales();
    private String path;
    ...
    private void enviarEmail(final Mensaje mensaje, final File f) {
        new Thread() {
            ...
            public void run() {
                ...
                boolean enviado = CorreoSMTP.enviarCorreo(mensaje.getDe(), mensaje.getPara(), mensaje.getAsunto(), texto);
                if (f != null) {
                    CorreoSMTP.enviarCorreoConAdjuntos(mensaje.getDe(), mensaje.getPara(), mensaje.getAsunto(), texto, f);
                }
