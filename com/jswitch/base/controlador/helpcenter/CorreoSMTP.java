...
public class CorreoSMTP {
    ...
    public static boolean enviarCorreo(String from, String to, String asunto, String mensaje) {
        return enviarCorreo(General.configuracion.getServidorSMTP(), from, to, asunto, mensaje);
    }
    ...
    private static boolean enviarCorreo(String smtpHost, String from, String to, String asunto, String mensaje) {
        ...
        try {
            correo.setFrom(new InternetAddress(from.trim()));
            correo.setRecipient(Message.RecipientType.TO, new InternetAddress(to.trim()));
            correo.setSubject(asunto);
            correo.setText(mensaje);
            Transport.send(correo);
        } catch (MessagingException ex) {
            LoggerUtil.error(CorreoSMTP.class, "enviarCorreo", ex);
            return false;
        }
        return true;
    }
    ...
    public static void enviarCorreoConAdjuntos(String from, String to, String asunto, String mensaje, File... archivos) {
        enviarCorreoConAdjuntos(General.configuracion.getServidorSMTP(), from, to, asunto, mensaje, archivos);
    }
